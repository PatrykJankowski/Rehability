    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 mb-20 mb-0-lg">
                <div class="font-size-22 text-white italic leading-6"><strong>Rehability</strong> to gabinet rehabilitacji zlokalizowany na Warszawskich Bielanach, specjalizujący się w rehabilitacji sportowej.</div>

                <h4 class="font-size-22 text-white italic mt-2 mb-6">Skontaktuj się z nami!</h4>
