    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 mb-20 mb-0-lg">
                <div class="font-size-22 text-white italic leading-6"><?php echo get_field('footer_description') ?></div>

                <h4 class="font-size-22 text-white italic mt-2 mb-6"><?php echo get_field('footer_contact_header') ?></h4>
                ...
                <div class="mt-6 space-x-5">
                    <a href="<?php echo get_field('contact_email', 2) ?>" target="_blank">
            ...
            <div class="col-lg-5 text-white">
                <h2 class="mb-6 font-size-22 font-size-30-lg"><?php echo get_field('footer_newsletter_header') ?></h2>
