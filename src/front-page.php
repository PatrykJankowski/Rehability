    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-xxl-3 flex flex-col 2xl:flex-row items-center text-center 2xl:text-left">
                ...
                <?php echo get_field('homepage_info_col_1') ?>
            </div>
            <div class="col-md-6 col-xxl-3 flex flex-col 2xl:flex-row items-center text-center 2xl:text-left">
                ...
                <?php echo get_field('homepage_info_col_2') ?>
            </div>
            <div class="col-md-6 col-xxl-3 flex flex-col 2xl:flex-row items-center text-center 2xl:text-left">
                ...
                <?php echo get_field('homepage_info_col_3') ?>
            </div>
            <div class="col-md-6 col-xxl-3 flex flex-col 2xl:flex-row items-center text-center 2xl:text-left">
                ...
                <?php echo get_field('homepage_info_col_4') ?>
            </div>
        </div>
    </div>
</section>
